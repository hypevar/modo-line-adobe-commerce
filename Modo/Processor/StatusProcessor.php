...
class StatusProcessor implements PaymentProcessorInterface
{
    ...
    public function execute(
        ...
        // region This block will avoid to notify multiple times until the Line Response changes
        $lastHashResponse = $paymentAdditionalInfo[ConfigInterface::ORDER_ADDITIONAL_KEY]['lastHashResponse'] ?? '';
        $currentHashResponse = $this->encryptor->hash($this->serializer->serialize($modoPayment));
