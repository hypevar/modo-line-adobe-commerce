...
class PaymentProcessor implements PaymentProcessorInterface
{
    ...
    public function execute(
        ...
        if (!isset($paymentAdditionalInfo['line_modo']) ||
            !isset($paymentAdditionalInfo['line_modo']['id']) ||
            $paymentAdditionalInfo['line_modo']['id'] !== $paymentId
        ) {
        ...
        $invoices = [];
        foreach ($modoPayment['transactions'] as $transaction) {
